...
export const PageLayout = ({
  ...
  <div
    className={cn(
      'mx-auto flex min-h-svh w-full max-w-screen-sm flex-1 flex-col items-stretch p-6',
      'lg:max-w-screen-lg lg:flex-row lg:justify-between',
      className,
    )}
  >
    <nav
      className={cn('sticky top-0 flex flex-col gap-8', 'lg:max-h-svh lg:w-64')}
    >
      <div className="flex flex-col gap-4">
        ...
        <h1 className="font-serif text-3xl font-extrabold text-gray-100 sm:text-4xl">
          {title}
        </h1>
      </div>
    ...
    <div className="mx-auto flex w-full max-w-screen-sm flex-1 flex-col gap-12 py-8">
