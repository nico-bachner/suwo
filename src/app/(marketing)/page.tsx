...
export default function Page() {
  return (
    <div className="prose mx-auto max-w-screen-sm">
      ...
      <p>
        <Link href="/join">Join us</Link> to become part of Sydney University’s
        “BEST SMALL CLUB” 2006, 2007, 2008, 2009 and 2010 – and NSW’s “Champion
        Open B Grade Concert Band” 2011!
      </p>
